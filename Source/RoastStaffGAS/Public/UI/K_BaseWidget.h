...
#include "K_BaseWidget.generated.h"
 ...
 */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnCloseUIRequested, UK_BaseWidget*, RequestingWidget);
 ...
 */
UCLASS()
class ROASTSTAFFGAS_API UK_BaseWidget : public UUserWidget
{
	GENERATED_BODY()
public:
	/** UI를 활성화하고 화면에 표시 */
