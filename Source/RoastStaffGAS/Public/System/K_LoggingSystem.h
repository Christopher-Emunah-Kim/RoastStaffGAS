...
#include "Engine/Engine.h" // KHS_SCREEN_INFO 사용을 위해 포함

// =============================================================================
// I. 필수 (CORE) 로깅 시스템 구성 요소
// =============================================================================
// -----------------------------------------------------------------------------
// 1. 필수: 로그 카테고리 선언
// -----------------------------------------------------------------------------
// KHS 전역 로깅 카테고리 선언함
ROASTSTAFFGAS_API DECLARE_LOG_CATEGORY_EXTERN(LogKHS, Log, All);

// -----------------------------------------------------------------------------
// 2. 필수: 로그 레벨 정의 및 UE Verbosity 매핑
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// 3. 필수: 빌드 환경별 컴파일 타임 최적화 (Shipping 필터링)
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// 5. 필수: 6대 기본 로그 레벨 매크로 (사용자 인터페이스)
// -----------------------------------------------------------------------------

// --- 전역 카테고리 (LogKHS) 사용 매크로 ---
